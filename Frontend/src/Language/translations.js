...
export const translations = {
  ...
  bn: {
    ...
    register: {
      eyebrow: "নতুন যাত্রা শুরু করুন",
      title: "SHOBDO-তে যোগ দিন",
      description:"নিজের ভাষায় লিখুন, আপনার ভাবনা প্রকাশ করুন এবং পাঠকদের সঙ্গে যুক্ত হন।",
      name: "নাম",
      namePlaceholder: "আপনার সম্পূর্ণ নাম",
      email: "ইমেইল",
      emailPlaceholder: "আপনার ইমেইল ঠিকানা",
  ...
  en: {
    ...
    register: {
      ...
      title: "Join SHOBDO",
      description:"Write in your language, share your ideas, and connect with readers.",
      name: "Name",
      namePlaceholder: "Your full name",
      email: "Email",
      emailPlaceholder: "Your email address",
  ...
  hi: {
    ...
    register: {
      ...
      title: "SHOBDO से जुड़ें",
      description:"अपनी भाषा में लिखें, अपने विचार साझा करें और पाठकों से जुड़ें।",
      name: "नाम",
      namePlaceholder: "आपका पूरा नाम",
      email: "ईमेल",
      emailPlaceholder: "आपका ईमेल पता",
